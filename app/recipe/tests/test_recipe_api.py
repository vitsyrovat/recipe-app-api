...
import os   # allow create patch and check existence of files
...
class PrivateApiTest(TestCase):
    ...
    def test_retriev_recipes(self):
        ...
        sample_recipe(user=self.user, title='Potatoes')
    ...
    def test_recipes_limited_to_user(self):
        ...
        sample_recipe(user=self.user, title='potaty')
    ...
    def test_create_recipe_with_tags(self):
        ...
        tag3 = sample_tag(user=self.user, name='Peach')
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Hazelnuts')
